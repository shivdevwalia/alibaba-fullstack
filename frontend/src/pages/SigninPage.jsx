...
function SigninPage() {
  ...
  useEffect(() => {
    if (isAuth) {
      if (role === "admin") {
        navigate("/dashboard/products"); // admin dashboard route
      } else {
  ...
  const loadingSignin = useSelector((state) => state.loadingSignin);
        ...
        <Flex flex="1" justify="center" align="center">
          ...
          >
            <Flex flexDirection={"column"} align={"center"} w="100%">
              ...
              {errorSignin && showError && (
                <Alert status="error" borderRadius="md" mb={4}>
                  <AlertIcon />
                  <AlertDescription flex="1">{errorSignin}</AlertDescription>
                  <CloseButton
              ...
              <Box mt={2} mb={4} width="100%" textAlign="right">
                <Text
                  fontSize="sm"
                  fontWeight="bold"
                  cursor="pointer"
              ...
              <Flex mt={2} align={"center"} flexDirection={"row"}>
                <Text color={"gray"} fontSize={14} fontWeight={400} mr={2}>
                  New to Alibaba.com?
                </Text>
                <Text
